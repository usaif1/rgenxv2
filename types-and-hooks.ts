...
export const FetchAllPatientsDocument = `
...
export const useFetchAllPatientsQuery = <
      TData = FetchAllPatientsQuery,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      variables?: FetchAllPatientsQueryVariables,
      options?: UseQueryOptions<FetchAllPatientsQuery, TError, TData>
    ) => {
    
    return useQuery<FetchAllPatientsQuery, TError, TData>(
      variables === undefined ? ['fetchAllPatients'] : ['fetchAllPatients', variables],
      fetcher<FetchAllPatientsQuery, FetchAllPatientsQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, FetchAllPatientsDocument, variables),
      options
    )};
