...
export const FetchAllPatientsDocument = gql`
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    fetchAllPatients(variables?: FetchAllPatientsQueryVariables, options?: C): Promise<FetchAllPatientsQuery> {
      return requester<FetchAllPatientsQuery, FetchAllPatientsQueryVariables>(FetchAllPatientsDocument, variables, options) as Promise<FetchAllPatientsQuery>;
    }
  };
}
